...
Route::prefix('user')->middleware(['auth', 'role:user'])->group(function () {
    ...
    Route::get('sk/export/csv', [SuratKeputusanController::class, 'exportCsv'])->name('sk.export');
    Route::get('sp/export/csv', [SuratPerjanjianController::class, 'exportCsv'])->name('sp.export');
    Route::get('addendum/export/csv', [SuratAddendumController::class, 'exportCsv'])->name('addendum.export');
    ...
    Route::resource('sp', SuratPerjanjianController::class);
    Route::get('sp/{id}/download', [SuratPerjanjianController::class, 'downloadPdf'])->name('sp.download');
    
    Route::resource('addendum', SuratAddendumController::class);
