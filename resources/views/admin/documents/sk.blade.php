...
@section('title', 'Semua Surat Keputusan')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-file-text"></i> Semua Surat Keputusan</h2>
        <div>
            <a href="{{ route('admin.documents.sk.export', request()->query()) }}" class="btn btn-success me-2" target="_blank">
                <i class="bi bi-download"></i> Export CSV
            </a>
            <a href="{{ route('admin.documents.sk.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                <div class="col-md-6">
                    <label for="search" class="form-label">Cari Nomor SK, Perihal, atau User</label>
                ...
                <div class="col-md-3">
                    ...
                    <div class="btn-group w-100" role="group">
                        <a href="{{ route('admin.documents.sk', array_merge(request()->query(), ['sort' => 'asc'])) }}" 
                           class="btn btn-outline-secondary {{ request('sort') === 'asc' ? 'active' : '' }}">
                            <i class="bi bi-arrow-up"></i> ASC
                        </a>
                        <a href="{{ route('admin.documents.sk', array_merge(request()->query(), ['sort' => 'desc'])) }}" 
                ...
                <div class="col-md-3">
                    <a href="{{ route('admin.documents.sk') }}" class="btn btn-warning w-100">
    ...
    @if($documents->count() > 0)
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Daftar Surat Keputusan</h5>
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong>{{ $doc->NOMOR_SK }}</strong></td>
