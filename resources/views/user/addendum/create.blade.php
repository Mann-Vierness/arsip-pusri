    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-0" style="color:#222"><i class="bi bi-file-earmark-plus"></i> Tambah Addendum</h2>
                    <p class="text-muted mb-0">Buat Addendum baru (bisa backdate)</p>
                </div>
                <a href="{{ route('user.addendum.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
            </div>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('user.addendum.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('PERIHAL') is-invalid @enderror" name="PERIHAL" rows="2" required>{{ old('PERIHAL') }}</textarea>
