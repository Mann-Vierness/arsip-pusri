    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                <div class="col-md-6">
                    <label for="search" class="form-label">Cari Nomor SK atau Perihal</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="search" name="search" 
                               placeholder="Masukkan nomor SK atau perihal..." value="{{ request('search') }}">
    ...
    @else
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h4 class="mt-3">Belum Ada Surat Keputusan</h4>
                <p class="text-muted">Klik tombol "Tambah SK" untuk membuat surat keputusan baru</p>
                <a href="{{ route('user.sk.create') }}" class="btn btn-primary mt-2">
                    <i class="bi bi-plus-circle"></i> Tambah SK
                </a>
            </div>
        </div>
