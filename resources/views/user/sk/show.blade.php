                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                            ...
                            <td>: <strong>{{ $document->NOMOR_SK }}</strong></td>
                        </tr>
                        <tr>
                            <th>Tanggal</th>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('user.sk.download', $document->id) }}" class="btn btn-success btn-sm w-100 mb-2">
                    ...
                    <form action="{{ route('user.sk.destroy', $document->id) }}" method="POST" 
